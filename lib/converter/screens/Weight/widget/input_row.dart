...
import 'package:calculator/converter/screens/Weight/model/weight_list.dart';
...
class _InputRowState extends State<InputRow> {
  late final WeightList _weightList = WeightList();
      ...
      builder: (BuildContext context) {
        return Container(
          ...
          child: ListView.builder(
            shrinkWrap: true,
            itemCount: _weightList.getLength(),
            itemBuilder: (context, index) {
              return ListTile(
                onTap: () {
                  _selectUnit(_weightList.getUnitSymbol(index));
                  Navigator.pop(context);
                },
                title: Text(
                  _weightList.getUnitName(index),
