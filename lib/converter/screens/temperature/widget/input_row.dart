...
import 'package:calculator/converter/screens/temperature/model/temperature_list.dart';
...
class _InputRowState extends State<InputRow> {
  late final TemperatureList _tempList = TemperatureList();
      ...
      builder: (BuildContext context) {
        return Container(
          ...
          child: ListView.builder(
            shrinkWrap: true,
            itemCount: _tempList.getLength(),
            itemBuilder: (context, index) {
              return ListTile(
                onTap: () {
                  _selectUnit(_tempList.getUnitSymbol(index));
                  Navigator.pop(context);
                },
                title: Text(
                  _tempList.getUnitName(index),
