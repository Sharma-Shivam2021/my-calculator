import 'package:calculator/converter/screens/Area/model/area_list.dart';
...
class _InputRowState extends State<InputRow> {
  late final AreaList _areaList = AreaList();
      ...
      builder: (BuildContext context) {
        return Container(
          ...
          child: ListView.builder(
            shrinkWrap: true,
            itemCount: _areaList.getLength(),
            itemBuilder: (context, index) {
              return ListTile(
                onTap: () {
                  _selectUnit(_areaList.getUnitSymbol(index));
                  Navigator.pop(context);
                },
                title: Text(
                  _areaList.getUnitName(index),
