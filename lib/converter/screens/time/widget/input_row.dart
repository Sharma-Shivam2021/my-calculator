...
import 'package:calculator/converter/screens/time/model/time_list.dart';
...
class _InputRowState extends State<InputRow> {
  late final TimeList _timeList = TimeList();
  String selectedUnit = 's';
      ...
      builder: (BuildContext context) {
        return Container(
          ...
          child: ListView.builder(
            shrinkWrap: true,
            itemCount: _timeList.getLength(),
            itemBuilder: (context, index) {
              return ListTile(
                onTap: () {
                  _selectUnit(_timeList.getUnitSymbol(index));
                  Navigator.pop(context);
                },
                title: Text(
                  _timeList.getUnitName(index),
